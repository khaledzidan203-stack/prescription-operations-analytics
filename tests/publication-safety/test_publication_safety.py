...
REQUIRED_DOCS = {
    ...
    "docs/workflows/run-x-workflow.md",
    "docs/workflows/pick-up-workflow.md",
...
def test_public_text_has_no_high_risk_literals():
    patterns = {
        ...
        "active_source": re.compile(r"WasfatyCentral[\\/]Source[\\/]WasfatyCentral", re.I),
...
def test_relative_markdown_links_resolve():
    ...
    for path in ROOT.rglob("*.md"):
        ...
        if relative.as_posix() == "docs/INITIAL_PORTFOLIO_README.md":
            continue  # immutable historical baseline retained byte-for-byte
        content = path.read_text(encoding="utf-8")
